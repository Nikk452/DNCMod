...
public class ExperienceData {
    ...
    public static void LevelUp(ServerPlayerEntity player,int class_type){
        ...
        if(nbt.getInt("experience")>=nbt.getInt("max_experience")){
            ...
            classMovementSpeed(player,class_type,total_level);
            AttributeData.setHealth(player,nbt.getInt("con_health_boost"),total_level*nbt.getInt("con_health_boost"),"con_health_boost","80b3a28a-42cd-4926-8327-91e75ab0191f");
    ...
    private static void classMovementSpeed(ServerPlayerEntity player, int class_type, int total_level){
        switch(class_type){
